<div id="sb_menu">
    ...
    ?>
    <div class="sm_menu_item<?php if ($area == 4) echo ' sm_menu_active'; ?>"><a href="?area=4">Import</a></div>


    <div class="sm_menu_item<?php if ($area == 1) echo ' sm_menu_active'; ?>"><a href="?area=1">Automated Backups</a></div>
